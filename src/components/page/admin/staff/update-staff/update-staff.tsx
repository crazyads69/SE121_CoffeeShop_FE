...
import PostUpdateStaff from "@/api/staff/post-update-staff";
...
export default function UpdateStaff({
    ...
    // set value for each input when component mount
    useEffect(() => {
        if (staff) {
            setName(staff.name);
...
items-center justify-start border-b border-[#000000] pb-[0.56rem] pl-[1rem] pt-[0.69rem]"
                        >
                            <h1 className="font-sans text-[1rem] font-bold">Cập nhật nhân viên</h1>
                        </div>
                        {/* Product info */}
