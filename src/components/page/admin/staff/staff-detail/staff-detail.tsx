...
import DeleteStaffItem from "../delete-staff/delete-staff-item";
import UpdateStaff from "../update-staff/update-staff";
...
export default function StaffDetail({ setShowStaffDetail, staff }: StaffDetailProps) {
    // State for show/hide delete staff modal
    const [showDeleteStaffModal, setShowDeleteStaffModal] = useState<boolean>(false);
    // State for update staff modal
        ...
        >
            ...
            <div className="fixed inset-0 z-10 w-screen">
                <div className="flex h-full items-center justify-center">
                    <div
                        className="relative flex h-[20.4375rem]
                        ...
                        <div className="mt-[1.56rem] flex w-full flex-row items-start justify-start">
                            <div className="ml-[2rem] flex flex-col items-start justify-start">
                                ...
                                <div className="grid grid-flow-col grid-cols-2 items-center justify-start gap-[1rem]">
                                    <h1 className="font-sans text-[1rem]">Mã nhân viên:</h1>
                                    <p className="col-start-2 font-sans text-[1rem] font-bold">
                                        {staff.id}
                                    </p>
                                    <h1 className="font-sans text-[1rem]">Tên nhân viên: </h1>
                                    <p className="col-start-2 font-sans text-[1rem] font-bold">
                                        {staff.name}
                                    </p>
                                ...
                                <div className="mt-[2.88rem] flex flex-row items-center justify-start">
