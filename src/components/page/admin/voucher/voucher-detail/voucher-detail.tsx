...
export default function VoucherDetail({ voucher, setShowVoucherDetail }: VoucherDetailProps) {
    ...
    const [showUpdateVoucherModal, setShowUpdateVoucherModal] = useState<boolean>(false);
                        ...
                        <div className="mt-[1.56rem] flex w-full flex-row items-start justify-start">
                            <div className="ml-[2rem] flex flex-col items-start justify-start">
                                ...
                                <div className="grid grid-flow-col grid-cols-2 items-center justify-start gap-[1rem]">
                                    <h1 className="font-sans text-[1rem]">Mã voucher:</h1>
                                    <p className="col-start-2 font-sans text-[1rem] font-bold">
                                        {voucher.voucher_code}
                                    </p>
                                    <h1 className="font-sans text-[1rem]">Loại voucher: </h1>
                                    <p className="col-start-2 font-sans text-[1rem] font-bold">
                                        {voucher.type === "percent"
                                            ? "Giảm giá theo phần trăm"
                                            : "Giảm giá trực tiếp"}
                                    </p>
                                    <h1 className="font-sans text-[1rem]">Số lượng: </h1>
                                    <p className="col-start-2 font-sans text-[1rem] font-bold">
                                        {voucher.quantity}
                                    </p>
                                    ...
                                    <h1 className="font-sans text-[1rem]">
                                        Ngày bắt đầu - Ngày hết hạn:{" "}
                                    </h1>
                                    <p className="col-start-2 font-sans text-[1rem] font-bold">
                                        {`${convertDate(voucher.start_date)} -
...
justify-between rounded-md bg-[#12582E] px-[0.86rem] pb-[0.8rem] pt-[0.75rem]"
                                        onClick={() => {
                                            setShowUpdateVoucherModal(true);
                                        }}
                                    >
                                        <svg
                                            xmlns="http://www.w3.org/2000/svg"
