...
import { addSelectedVoucher, removeSelectedVoucher } from "@/redux/slices/voucher-slice";
...
export default function SelectVoucher({ voucherCode }: SelectVoucherProps) {
    ...
    const selectedVouchers = useSelector((state: RootState) => state.voucher.selectedVoucher);
                ...
                <input
                    ...
                    onClick={() => {
                        ...
                        if (checked) {
                            ...
                            dispatch(addSelectedVoucher(Number(voucherCode)));
                        }
                    }}
