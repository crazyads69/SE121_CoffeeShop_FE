...
import DeleteVouchers from "@/api/voucher/delete-vouchers";
...
export default function DeleteVoucherList({
    ...
    const selectVoucherList = useSelector((state: RootState) => state.voucher.selectedVoucher);
    const handleDeleteVoucherList = async () => {
        await DeleteVouchers(selectVoucherList, setShowDeleteVoucherModal, dispatch);
    };
    return (
        <div
