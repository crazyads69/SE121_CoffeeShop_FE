...
import { removeAllSelectedLoyals, setSelectedLoyal } from "@/redux/slices/loyal-slice";

export default function SelectAllLoyal() {
                ...
                <input
                    ...
                    onClick={() => {
                        ...
                        if (checked) {
                            ...
                            const newLoyalList = loyals.map((loyal) => String(loyal.id));
                            dispatch(setSelectedLoyal(newLoyalList));
                        }
                    }}
