...
export interface AddLoyalProps {
    setShowAddLoyalModal: (show: boolean) => void;
}

const loyalTypeList = ["direct", "percent"];

export default function AddLoyalItem({ setShowAddLoyalModal }: AddLoyalProps) {
    ...
    const handleSaveLoyal = async () => {
        ...
        // Call api to save loyal
        await PostAddLoyal(
            loyalName,
            minSpendNumber,
            loyalType,
            amount,
            setShowAddLoyalModal,
            dispatch,
        );
    };
    return (
