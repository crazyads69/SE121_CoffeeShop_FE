...
import DeleteCustomers from "@/api/customer/delete-customers";
...
export default function DeleteCustomerList({
    showDeleteCustomerModal,
    setShowDeleteCustomerModal,
}: DeleteCustomerListProps) {
    const dispatch = useDispatch();
    const selectedCustomerList = useSelector((state: RootState) => state.customer.selectedCustomer);
    const handleDeleteCustomerList = async () => {
        await DeleteCustomers(selectedCustomerList, setShowDeleteCustomerModal, dispatch);
    };
    return (
        <div
                    ...
                    <div className="relative flex h-[24rem] w-[33.125rem] transform flex-col items-center justify-start overflow-hidden rounded-md bg-white p-[3.12rem] shadow-[0px_5px_12px_0px_rgba(0,0,0,0.10)] transition-all">
                        ...
                        <div className="mt-[2.19rem] flex w-full flex-row items-center justify-center space-x-[1.12rem]">
                            ...
                            <button
                                ...
                                onClick={handleDeleteCustomerList}
                            >
                                Đồng ý
                            </button>
                        </div>
