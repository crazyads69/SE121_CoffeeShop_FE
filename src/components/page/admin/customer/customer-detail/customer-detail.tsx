...
import DeleteCustomerItem from "../delete-customer/delete-customer-item";
...
export default function CustomerDetail({ customer, setShowCustomerDetail }: CustomerDetailProps) {
                        ...
                        <div className="mt-[1.56rem] flex w-full flex-row items-start justify-start">
                            <div className="ml-[2rem] flex flex-col items-start justify-start">
                                ...
                                <div className="grid grid-flow-col grid-cols-2 items-center justify-start gap-[1rem]">
                                    <h1 className="font-sans text-[1rem]">Mã khách hàng:</h1>
                                    <p className="col-start-2 font-sans text-[1rem] font-bold">
                                        {customer.id}
                                    </p>
                                    <h1 className="font-sans text-[1rem]">Tên khách hàng:</h1>
                                    <p className="col-start-2 font-sans text-[1rem] font-bold">
                                        {customer.name}
                                    </p>
                                    <h1 className="font-sans text-[1rem]">Số điện thoại: </h1>
                                    <p className="col-start-2 font-sans text-[1rem] font-bold">
                                        {customer.phone_number}
                                    </p>
                                    <h1 className="font-sans text-[1rem]">Ngày tham gia: </h1>
                                    <p className="col-start-2 font-sans text-[1rem] font-bold">
                                        {convertIsoStringToDate(customer.created_at)}
                                    </p>
                                </div>
