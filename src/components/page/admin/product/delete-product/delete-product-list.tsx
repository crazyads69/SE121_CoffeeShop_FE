...
export default function DeleteProductList({
    ...
    const selectProductList = useSelector((state: RootState) => state.product.selectedProduct);
    const handleDeleteProductList = async () => {
        ...
        await DeleteProducts(selectProductList, dispatch, setShowDeleteProductModal);
    };
    return (
        <div
