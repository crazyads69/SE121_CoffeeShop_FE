...
import { addSelectedProduct, removeSelectedProduct } from "@/redux/slices/product-slice";
...
export default function SelectProduct({ productCode }: SelectProductProps) {
    ...
    const selectedProducts = useSelector((state: RootState) => state.product.selectedProduct);
                ...
                <input
                    ...
                    onClick={() => {
                        ...
                        if (checked) {
                            ...
                            dispatch(addSelectedProduct(productCode));
                        }
                    }}
